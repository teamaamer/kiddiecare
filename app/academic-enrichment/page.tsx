        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="bg-white/95 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
              ...
              <div className="bg-gentle-green/10 rounded-2xl p-4">
                <h4 className="font-bold text-text-charcoal mb-2 flex items-center gap-2">
                  <svg className="w-5 h-5 text-gentle-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  Outdoor Adventures (School Age)
                </h4>
                <p className="text-text-charcoal/70 text-sm">
                  School-age children participate in exciting outdoor field trips, nature exploration, and physical activities that promote health and teamwork.
                </p>
              </div>
