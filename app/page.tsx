...
export default function Home() {
  return (
    <main>
      ...
      <Section className="bg-gradient-to-b from-gentle-green/10 to-peach/10" backgroundImage="/bg-teddy2.png">
        <AboutSection />
      </Section>

      <Section className="bg-gradient-to-b from-peach/10 to-lavender/10">
        <ActivitiesSection />
      </Section>

      <Section id="contact" className="bg-gradient-to-b from-gentle-green/10 to-sky-blue/10">
        <ContactFormSection />
      </Section>
    </main>
  );
